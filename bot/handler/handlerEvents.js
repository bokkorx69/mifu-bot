...
function getText(type, reason, time, targetID) {
  if (type == "userBanned")
    ...
    return "❌ | 𝗖𝗨𝗥𝗥𝗘𝗡𝗧𝗟𝗬, 𝗢𝗡𝗟𝗬 𝗧𝗛𝗘 𝗕𝗢𝗧'𝗦 𝗔𝗗𝗠𝗜𝗡 𝗖𝗔𝗡 𝗨𝗦𝗘 𝗧𝗛𝗜𝗦 𝗕𝗢𝗧.";
  return "";
}

function heTxt(key, ...args) {
  const tpl = {
    commandNotFound: '🎀\n\n 𝐂𝐨𝐦𝐦𝐚𝐧𝐝  "%1" 𝐝𝐨𝐞𝐬 𝐧𝐨𝐭 𝐞𝐱𝐢𝐬𝐭, 𝐭𝐲𝐩𝐞 %2help 𝐭𝐨 𝐬𝐞𝐞 𝐚𝐥𝐥 𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬',
    commandNotFound2: " 🎀\n\n 𝐓𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐲𝐨𝐮 𝐚𝐫𝐞 𝐮𝐬𝐢𝐧𝐠 𝐝𝐨𝐞𝐬 𝐧𝐨𝐭 𝐞𝐱𝐢𝐬𝐭, 𝐭𝐲𝐩𝐞  %1help 𝐭𝐨 𝐬𝐞𝐞 𝐚𝐥𝐥 𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬 \n\n ||",
    commandSyntaxError: "𝐓𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐲𝐨𝐮 𝐚𝐫𝐞 𝐮𝐬𝐢𝐧𝐠 𝐢𝐬 𝐰𝐫𝐨𝐧𝐠 𝐬𝐲𝐧𝐭𝐚𝐱, 𝐩𝐥𝐞𝐚𝐬𝐞 𝐭𝐲𝐩𝐞 %1𝐡𝐞𝐥𝐩 %2 𝐭𝐨 𝐬𝐞𝐞 𝐭𝐡𝐞 𝐝𝐞𝐭𝐚𝐢𝐥𝐬 𝐨𝐟 𝐡𝐨𝐰 𝐭𝐨 𝐮𝐬𝐞 𝐭𝐡𝐢𝐬 𝐜𝐨𝐦𝐦𝐚𝐧𝐝",
    onlyAdmin: '❌ | 𝐎𝐧𝐥𝐲 𝐠𝐫𝐨𝐮𝐩 𝐚𝐝𝐦𝐢𝐧𝐢𝐬𝐭𝐫𝐚𝐭𝐨𝐫𝐬 𝐜𝐚𝐧 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 "%1"',
    onlyAdminToUseOnReply: '❌ | 𝐎𝐧𝐥𝐲 𝐠𝐫𝐨𝐮𝐩 𝐚𝐝𝐦𝐢𝐧𝐢𝐬𝐭𝐫𝐚𝐭𝐨𝐫𝐬 𝐜𝐚𝐧 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐫𝐞𝐩𝐥𝐲 𝐟𝐮𝐧𝐜𝐭𝐢𝐨𝐧 𝐨𝐟 𝐭𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 "%1"',
    onlyAdminToUseOnReaction: '❌ | 𝐎𝐧𝐥𝐲 𝐠𝐫𝐨𝐮𝐩 𝐚𝐝𝐦𝐢𝐧𝐢𝐬𝐭𝐫𝐚𝐭𝐨𝐫𝐬 𝐜𝐚𝐧 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐫𝐞𝐚𝐜𝐭𝐢𝐨𝐧 𝐟𝐮𝐧𝐜𝐭𝐢𝐨𝐧 𝐨𝐟 𝐭𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 "%1"',
    onlyAdminBot2: "❌ | 𝐎𝐧𝐥𝐲 𝐛𝐨𝐭'𝐬 𝐚𝐝𝐦𝐢𝐧 𝐜𝐚𝐧 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\"",
    onlyAdminBot2ToUseOnReply: "❌ | 𝐎𝐧𝐥𝐲 𝐛𝐨𝐭'𝐬 𝐚𝐝𝐦𝐢𝐧 𝐜𝐚𝐧 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐫𝐞𝐩𝐥𝐲 𝐟𝐮𝐧𝐜𝐭𝐢𝐨𝐧 𝐨𝐟 𝐭𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\"",
    onlyAdminBot2ToUseOnReaction: "❌ | 𝐎𝐧𝐥𝐲 𝐛𝐨𝐭'𝐬 𝐚𝐝𝐦𝐢𝐧 𝐜𝐚𝐧 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐫𝐞𝐚𝐜𝐭𝐢𝐨𝐧 𝐟𝐮𝐧𝐜𝐭𝐢𝐨𝐧 𝐨𝐟 𝐭𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\"",
    waitingForCommand: "⏱ 𝐘𝐨𝐮 𝐚𝐫𝐞 𝐢𝐧 𝐭𝐡𝐞 𝐰𝐚𝐢𝐭𝐢𝐧𝐠 𝐭𝐢𝐦𝐞 𝐭𝐨 𝐮𝐬𝐞 𝐭𝐡𝐢𝐬 𝐜𝐨𝐦𝐦𝐚𝐧𝐝, 𝐩𝐥𝐞𝐚𝐬𝐞 𝐜𝐨𝐦𝐞 𝐛𝐚𝐜𝐤 𝐚𝐟𝐭𝐞𝐫 %1𝐬",
    errorOccurred:  '❌ [ %1 ]\n𝐀𝐧 𝐞𝐫𝐫𝐨𝐫 𝐨𝐜𝐜𝐮𝐫𝐫𝐞𝐝 𝐚𝐭 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 "%2"\n\n%3',
    errorOccurred2: '❌ [ %1 ]\n𝐀𝐧 𝐞𝐫𝐫𝐨𝐫 𝐨𝐜𝐜𝐮𝐫𝐫𝐞𝐝 𝐚𝐭 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 "%2"\n\n%3',
    errorOccurred3: '❌ [ %1 ]\n𝐀𝐧 𝐞𝐫𝐫𝐨𝐫 𝐨𝐜𝐜𝐮𝐫𝐫𝐞𝐝 𝐰𝐡𝐞𝐧 𝐞𝐱𝐞𝐜𝐮𝐭𝐢𝐧𝐠 𝐨𝐧𝐑𝐞𝐩𝐥𝐲 𝐚𝐭 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 "%2"\n\n%3',
    errorOccurred4: '❌ [ %1 ]\n𝐀𝐧 𝐞𝐫𝐫𝐨𝐫 𝐨𝐜𝐜𝐮𝐫𝐫𝐞𝐝 𝐰𝐡𝐞𝐧 𝐞𝐱𝐞𝐮𝐭𝐢𝐧𝐠 𝐨𝐧𝐑𝐞𝐚𝐜𝐭𝐢𝐨𝐧 𝐚𝐭 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 "%2"\n\n%3',
    errorOccurred5: '❌ [ %1 ]\n𝐀𝐧 𝐞𝐫𝐫𝐨𝐫 𝐨𝐜𝐜𝐮𝐫𝐫𝐞𝐝 𝐰𝐡𝐞𝐧 𝐞𝐱𝐞𝐮𝐭𝐢𝐧𝐠 𝐨𝐧𝐄𝐯𝐞𝐧𝐭 𝐚𝐭 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 "%2"\n\n%3',
    errorOccurred6: '❌ [ %1 ]\n𝐀𝐧 𝐞𝐫𝐫𝐨𝐫 𝐨𝐜𝐜𝐮𝐫𝐫𝐞𝐝 𝐰𝐡𝐞𝐧 𝐞𝐱𝐞𝐮𝐭𝐢𝐧𝐠 𝐨𝐧𝐄𝐯𝐞𝐧𝐭 𝐚𝐭 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 "%2"\n\n%3',
    errorOccurred7: '❌ [ %1 ]\n𝐀𝐧 𝐞𝐫𝐫𝐨𝐫 𝐨𝐜𝐜𝐮𝐫𝐫𝐞𝐝 𝐰𝐡𝐞𝐧 𝐞𝐱𝐞𝐜𝐮𝐭𝐢𝐧𝐠 𝐨𝐧𝐀𝐧𝐲𝐄𝐯𝐞𝐧𝐭 𝐚𝐭 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 "%2"\n\n%3',
...
function isPremiumRequired(userData, senderID, commandName, message, langCode, command) {
  ...
  if (command && command.config.premium == true) {
    ...
    if (!userData.premium) {
      const premiumMessage = `🔒 𝗬𝗼𝘂 𝗮𝗿𝗲 𝗻𝗼𝘁 𝗮 𝗣𝗿𝗲𝗺𝗶𝘂𝗺 𝗠𝗲𝗺𝗯𝗲𝗿! 𝗜𝗳 𝘆𝗼𝘂 𝘄𝗮𝗻𝘁 𝘁𝗼 𝗮𝗰𝗰𝗲𝘀𝘀 𝘁𝗵𝗶𝘀 𝗳𝗲𝗮𝘁𝘂𝗿𝗲, 𝗽𝗹𝗲𝗮𝘀𝗲 𝗰𝗼𝗻𝘁𝗮𝗰𝘁 𝘁𝗵𝗲 𝗯𝗼𝘁 𝗼𝘄𝗻𝗲𝗿 𝗼𝗿 𝘂𝗽𝗴𝗿𝗮𝗱𝗲 𝘁𝗼 𝗣𝗿𝗲𝗺𝗶𝘂𝗺.
 ${config.prefix}𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗥𝗘𝗤𝗨𝗘𝗦𝗧 <𝗬𝗢𝗨𝗥 𝗠𝗘𝗦𝗦𝗔𝗚𝗘> 𝗧𝗢 𝗦𝗘𝗡𝗗 𝗔 𝗥𝗘𝗤𝗨𝗘𝗦𝗧 𝗙𝗢𝗥 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗔𝗖𝗖𝗘𝗦𝗦.`;
    ...
    if (config.adminOnly && config.adminOnly.enable === true && body && body.startsWith(isE2EEThread ? config.prefix : getPrefix(threadID))) {
      ...
      if (!isUserAdmin) {
        ...
        if (!global.adminOnlyNotificationSent.has(effectiveSenderID)) {
          ...
          const adminOnlyMsg = `🔒 𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬 𝗠𝗢𝗗𝗘 𝗜𝗦 𝗔𝗖𝗧𝗜𝗩𝗘. 𝗣𝗟𝗘𝗔𝗦𝗘 𝗪𝗔𝗜𝗧 𝗨𝗡𝗧𝗜𝗟 𝗔𝗡 𝗔𝗗𝗠𝗜𝗡 𝗗𝗜𝗦𝗔𝗕𝗟𝗘𝗦 𝗧𝗛𝗜𝗦 𝗠𝗢𝗗𝗘. 𝗧𝗛𝗔𝗡𝗞 𝗬𝗢𝗨! 💙`;
      ...
      if (stMessageData) {
        ...
        if (isAdminBot && body) {
          try {
            ...
            await message.reply('❌ Failed to send reply to  Bot server');
          }
        }
        return;
      }
